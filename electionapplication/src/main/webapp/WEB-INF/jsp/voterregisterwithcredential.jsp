...
<div class='parent' id="englishDiv" style="margin-left:20%;padding:1px 16px; margin-top:65px; margin-bottom:1px;"><!-- ----------------------------------PARENT DIV STARTS---------------------------------- -->   
	  
	<span style="visibility: hidden; " id="changeGovernorateAlreadyHappen"> </span>
	<div id="childDropLists" class='child'  style="width:900px; margin-top:102px; background-color:#679FAB;  border-radius: 25px;padding: 5px;">  
<!-- 	<div id="childDropLists" class='child' style="margin-right:1px; margin-bottom: 980px; border: none;"> -->
			<h2>Create User Id and Password</h2>          
			<h2>Select Constituency and Location</h2>          
	...
	<div id="childDropLists2" class='child' style=" border : none !important; margin-bottom: 1100px; position: absolute; top: 160px; right: 60px; margin-right: 100px;">    

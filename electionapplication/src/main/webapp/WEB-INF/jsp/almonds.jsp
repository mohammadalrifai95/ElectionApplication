...
About Us Screen is not available yet, it will be implemented soon.
	...
	<table style="color: #00008B;" >     
		<tr>		
			<td class="imageContainer" >
				<img src="<c:url value="/resources/images/almonds.jpg" />" alt="image" style="width: 900px; height: 350px;"/>   
			</td>
		</tr>
		<tr>
			<td class="imageContainer" >

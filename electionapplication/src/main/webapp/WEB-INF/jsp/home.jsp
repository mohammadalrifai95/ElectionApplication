...
<div   style=" background-color: #679FAB; width: 100%; height: 100px; color: white;" >  
...
<!-- 					<button id="searchButtonId" type="submit" style=" margin-left: 50px; width: 80px; height: 30px; background-color:  #00008B;" onclick="searchFunction()"><i  style="color: white; ">Login/Signup</i></button> -->
			...
			<tr>
				<td class="imageContainer" id="2017Td">
					<a href="/wheats"> 
						...
						<img src="<c:url value="/resources/images/jordainainvoteforthenation.jpg" />" alt="image"  style="width:1100px; height: 500px; "/> 
						</p>
<!-- 						</p>	 -->
					</a>	
				</td>
				<td class="imageContainer" id="2018Td">
					<a href="/walnuts">
						...
						<img src="<c:url value="/resources/images/jordanammanwithflag.jpg" />" alt="image" style="width:1100px; height: 400px; "/> 
						</p>	
					</a>
				...
				<td  class="imageContainer" id="2019Td">
					<a href="/almonds">
						...
						<img src="<c:url value="/resources/images/JORDAN-ELECTION-PARLIAMENT-RESULTS.jpg" />" alt="image"   style="width:1100px; height: 400px; " />
<!-- 						</p> -->
						</p>
					</a>
				</td>
				<td  class="imageContainer" id="2020Td">
					<a href="/little-of-us">
						...
						<img src="<c:url value="/resources/images/jordaneradahmalakiahsamiah.jpg" />" alt="image"  style="width:1100px; height: 400px; "  />
<!-- 						</p> -->
						</p>
					</a>
				</td>
				...
				<td  class="imageContainer" id="2021Td">
					<a href="/little-of-us">
						...
						<img src="<c:url value="/resources/images/jordanflagonhand.jpg" />" alt="image"  style="width:1100px; height: 400px; "  />
						</p>
					</a>
				</td>
				<td  class="imageContainer" id="2022Td">
					<a href="/little-of-us">
						...
						<img src="<c:url value="/resources/images/jordanmap.jpg" />" alt="image"   style="width:1100px; height: 400px; " />
						</p>
					</a>
				</td>
				<td  class="imageContainer" id="2023Td">
					<a href="/little-of-us">
						...
						<img src="<c:url value="/resources/images/jordanonthemap.jpg" />" alt="image" style="width:1100px; height: 400px; "    />
						</p>
					</a>
				</td>
				<td  class="imageContainer" id="2024Td">
					<a href="/little-of-us">
						<p style="margin-left: 80px; font-size: 70px; color: black;">
						<img src="<c:url value="/resources/images/jordanonthemap2.jpg" />" alt="image" style="width:1100px; height: 400px; "    />
						</p>
					</a>
				</td>
				<td  class="imageContainer" id="2025Td">
					<a href="/little-of-us">
						<p style="margin-left: 80px; font-size: 70px; color: black;">
						<img src="<c:url value="/resources/images/jordanparlamiante.jpg" />" alt="image" style="width:1100px; height: 400px; "    />
						</p>
					</a>
				</td>
				<td  class="imageContainer" id="2026Td">
					<a href="/little-of-us">
						<p style="margin-left: 80px; font-size: 70px; color: black;">
						<img src="<c:url value="/resources/images/jordanTreasury_petra_crop.jpeg" />" alt="image" style="width:1100px; height: 400px; "    />
						</p>
					</a>
				</td>
				<td  class="imageContainer" id="2027Td">
					<a href="/little-of-us">
						<p style="margin-left: 80px; font-size: 70px; color: black;">
						<img src="<c:url value="/resources/images/jordan-vote-concept-man-hand-ballot-box-election-day-jordan-flag-vector.jpg" />" alt="image" style="width:1100px; height: 400px; "    />
						</p>
					</a>
				</td>
	...
	<table style="color: #00008B;" >     
		<tr>
			<td class="imageContainer" >
				<a href="/"> 
					<img src="<c:url value="/resources/images/button-go-back.gif" />" alt="image" style="width: 100px;"/>   
				</a>
			</td>
	</tr>
	</table>
...
<!-- 						<p style="font-size: 80px;" id="tdDotId2"> -->
	...
	<div style="border:1px solid gray; width: 100%; height:auto; "> 	
		...
		<div class="parent"  style="border: none">  
			<div class="child" style="border: none; margin-right: 50px;" >
				 		At Fresh table green, we strive every day to contribute to the socio-economic development of the countries and regions where we produce world-class food and agro-industrial products.
...
<%-- 				<td><h2 style="color: #00008B;">Mission <img src="<c:url value="/resources/images/Recurso.png" />" alt="image"border="0"/></h1></td>  --%>
				<td><h2 style="color: #00008B;">Mission <img src="<c:url value="/resources/images/Mission.gif" />" alt="image"border="0"  style="width: 100px; height: 100px;" class="circular_image"/></h1></td> 
...
<%-- 							<td><img src="<c:url value="/resources/images/1.png" />" alt="image"border="0"/></td> --%>
							<td><img src="<c:url value="/resources/images/Diligence.png" />" alt="image"border="0" style="width: 120px; height: 80px" class="circular_image"/></td>
							<td>
...
<%-- 							<td><img src="<c:url value="/resources/images/2.png" />" alt="image"border="0"/></td> --%>
							<td><img src="<c:url value="/resources/images/teamwork.gif" />" alt="image"border="0" style="width: 120px; height: 80px" /></td>
							<td>
...
<%-- 								<img src="<c:url value="/resources/images/3.png" />" alt="image"border="0"/> --%>
								<img src="<c:url value="/resources/images/Honesty.gif" />" alt="image"border="0" style="width: 100px; height: 100px;" class="circular_image"/>
							</td>
							<td>
				...
				<td>
					<table>
						<tr>
							<td>
								<img src="<c:url value="/resources/images/Perseverance.jpg" />" alt="image"border="0" style="width: 100px; height: 100px;" class="circular_image"/>
...
<%-- 								<img src="<c:url value="/resources/images/5.png" />" alt="image"border="0"/> --%>
								<img src="<c:url value="/resources/images/Responsability2.jpg" />" alt="image"border="0"  style="width: 100px; height: 100px;" class="circular_image"/>
							</td>
							<td>
				...
				<td>
					<table>
						<tr>
							<td>
								<img src="<c:url value="/resources/images/6.png" />" alt="image"border="0" style="width: 100px; height: 100px;" class="circular_image"/>
							</td>
							<td>
...
<div style="background-color: #00008B; width:100%; height:160px;  color:white;">   
 <p>
